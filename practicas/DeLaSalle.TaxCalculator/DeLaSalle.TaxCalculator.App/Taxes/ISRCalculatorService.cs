...
public class ISRCalculatorService
{
    ...
    public ISRCalculatorService()
    {
        ...
        _limits = new List<Limit
        {
            ...
            new Limit{ LowerLimit = 735.01, UpperLimit = 65651.07 , FixedFee = 148.51,  SurplusPercentage = 6.40},
            new Limit{ LowerLimit = 65651.08, UpperLimit = 115375.90 , FixedFee = 3855.14,  SurplusPercentage = 1088},
            new Limit{ LowerLimit = 15375.91, UpperLimit = 134119.41 , FixedFee = 9265.20,  SurplusPercentage = 16.00},
            new Limit{ LowerLimit = 134119.42, UpperLimit = 160577.65 , FixedFee = 12264.16,  SurplusPercentage = 17.92},
            new Limit{ LowerLimit = 160577.661, UpperLimit = 23862.00 , FixedFee = 17005.47,  SurplusPercentage = 21.36},
